<?php /*a:4:{s:72:"/mnt/hgfs/project/project/小范博客/blogs/app/view/article/index.html";i:1687194107;s:70:"/mnt/hgfs/project/project/小范博客/blogs/app/view/common/head.html";i:1686930876;s:72:"/mnt/hgfs/project/project/小范博客/blogs/app/view/common/header.html";i:1686933356;s:72:"/mnt/hgfs/project/project/小范博客/blogs/app/view/common/footer.html";i:1686930048;}*/ ?>
<!DOCTYPE html>
<html lang="zh-Hans">
...
<main class="page">
  <div class="page-bd">
    ...
    <div class="tzt-panel">
      ...
      <div class="tzt-panel_bd clearfix">
        <p>
          <a href="-id=31.htm" tppabs="http://www.xiaofan.ink/?id=31">开源一款简单好看的记账系统，支持APP-微信小程序-H5</a>
        </p>
        <p>
          <a href="-id=29.htm" tppabs="http://www.xiaofan.ink/?id=29">PHP利用时间函数mktime获取多种时间戳的方式</a>
        </p>
        <p>
          <a href="-id=26.htm" tppabs="http://www.xiaofan.ink/?id=26">手把手教你用thinkphp+jwt做前后端分离</a>
        </p>
        <p>
          <a href="-id=25.htm" tppabs="http://www.xiaofan.ink/?id=25">thinkphp6 关于在项目根创建新目录用来存放类文件无法识别问题</a>
        </p>
        <p>
          <a href="-id=24.htm" tppabs="http://www.xiaofan.ink/?id=24">thinkphp前后端分离 tp6</a>
        </p>
      </div>
    </div>
